                ...
                case "grafico":
                    ...
                    switch (parameters.id)
                    {
                        case 1:
                            ...
                            foreach (var anioData in adapter.GetDatatable(String.Format(@"SELECT [fecha], [region], [precioPagIndustrial_PreciosPagInd], [ValorCompensacion_ValorCompensacion], [precioMinGarantia_precioMinGarantia]
                                            FROM [AgronetProyecciones].[dbo].[Algodon_Valores]
                            ...
                            {
                                serie1.data.Add(new Data { name = String.Format("{0:y}", Convert.ToDateTime(anioData["fecha"])), y = Convert.ToDouble(anioData["precioPagIndustrial_PreciosPagInd"]) });
                                serie2.data.Add(new Data { name = String.Format("{0:y}", Convert.ToDateTime(anioData["fecha"])), y = Convert.ToDouble(anioData["ValorCompensacion_ValorCompensacion"]) });
                                serie3.data.Add(new Data { name = String.Format("{0:y}", Convert.ToDateTime(anioData["fecha"])), y = Convert.ToDouble(anioData["precioMinGarantia_precioMinGarantia"]) });
                            }
